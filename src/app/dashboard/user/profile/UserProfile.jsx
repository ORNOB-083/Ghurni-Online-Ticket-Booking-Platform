...
export default function UserProfile({ user }) {
    ...
    const handleSaveImage = async () => {
        if (!previewImage) {
            toast.error('Please select or enter an image first');
            return;
        }
        setIsLoading(true);
        try {
        ...
        <div className="p-6 pt-8 max-w-4xl mx-auto space-y-6 mt-16">
                ...
                <div className="px-6 pb-6">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 -mt-12 mb-5">
                        <div className="relative inline-block">
                            <img
                                src={previewImage || `https://ui-avatars.com/api/?name=${encodeURIComponent(name || 'U')}&background=6366f1&color=fff&size=96`}
                                alt={name}
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex justify-center mb-5">
                            <img
                                src={previewImage || `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=6366f1&color=fff&size=96`}
                                alt="Preview"
                        ...
                        {imageTab === 'upload' ? (
                            ...
                            <div className="space-y-3">
                                ...
                                <button
                                    onClick={handleImageLinkPreview}
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full mt-4 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-500 text-white font-semibold text-sm shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 disabled:opacity-60 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
                        >
                            {isLoading ? (
            ...
            >
                {[
                    ...
                    { icon: Shield, label: 'Account Role', value: '✈️ Traveller', color: 'text-cyan-500', bg: 'bg-cyan-50 dark:bg-cyan-900/20' },
