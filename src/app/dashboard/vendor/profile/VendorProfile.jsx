        ...
        <div className="p-6 pt-8 max-w-4xl mx-auto space-y-6 mt-16">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
                    Manage your vendor information and photo
                </p>
            </motion.div>
            ...
            >
                {[
                    ...
                    { icon: Store, label: 'Account Role', value: '🏪 Vendor', color: 'text-cyan-500', bg: 'bg-cyan-50 dark:bg-cyan-900/20' },
            ...
            >
                ...
                <div className="flex flex-wrap gap-3">
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800">
                        ...
                        <span className="text-xs font-medium text-emerald-600 dark:text-emerald-400">Active Vendor</span>
                    </div>
                    {user?.emailVerified && (
