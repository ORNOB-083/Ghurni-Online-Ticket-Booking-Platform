...
export default function SignupPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            // Future: wire up better-auth signUp here
            router.push('/');
        } catch (err) {
    ...
    const handleGoogleSignup = async () => {
        // Future: wire up better-auth google here
    };

    return (
        <div className="flex-1 flex items-center justify-center px-4 py-12 min-h-[calc(100vh-64px)] bg-gray-50 dark:bg-[#0f1117]">
            <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-indigo-500/10 dark:bg-indigo-500/10 rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-cyan-500/10 dark:bg-cyan-500/10 rounded-full blur-[100px] pointer-events-none" />
            ...
            >
                <div className="bg-white/80 dark:bg-[#1a1d24]/80 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-3xl overflow-hidden shadow-2xl hover:shadow-2xl hover:shadow-indigo-500/20 dark:hover:shadow-indigo-900/40 transition-all duration-300 flex flex-col md:flex-row">
                    ...
                    <div className="relative w-full md:w-1/2 h-48 md:h-auto overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
                            <div className="flex items-center gap-3 md:gap-4 mb-3">
                                <span className="bg-gradient-to-r from-indigo-500 to-cyan-400 bg-clip-text text-transparent font-bold text-2xl md:text-3xl drop-shadow-sm">
                                    Ghurni
                                </span>
                            </div>
                            <p className="text-white/90 text-sm md:text-base leading-relaxed max-w-[240px] drop-shadow-sm">
                    ...
                    <div className="w-full md:w-1/2 p-8">
                        <div className="text-center mb-6">
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">
                                Create Your <span className="bg-gradient-to-r from-indigo-500 to-cyan-400 bg-clip-text text-transparent">Account</span>
                            </h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors flex items-center justify-center"
                                >
                        ...
                        <p className="text-center text-gray-500 dark:text-gray-400 text-xs mt-4">
                            ...
                            <Link href="/auth/signin" className="text-indigo-500 hover:text-indigo-600 dark:text-indigo-400 dark:hover:text-indigo-300 font-medium transition-colors">
                                Sign in
                            </Link>
                        </p>
                    </div>
